...
- (void)addHero {
    ...
    //    [editContext setPersistentStoreCoordinator:[[self.fetchedResultsController managedObjectContext] persistentStoreCoordinator]];
    //    NSEntityDescription *entity = [[self.fetchedResultsController fetchRequest] entity];
    //    NSManagedObject *newManagedObject = [NSEntityDescription insertNewObjectForEntityForName:[entity name] inManagedObjectContext:editContext];
    ...
    detailController.managedObject = newManagedObject;
    [self.navigationController pushViewController:detailController animated:YES];
    
    //[addingContext autorelease];
}
- (IBAction)toggleEdit {
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    detailController.managedObject = [self.fetchedResultsController 
