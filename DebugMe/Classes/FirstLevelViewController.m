...
- (void)viewDidLoad {
    ...
    InfiniteController *infiniteController = [[InfiniteController alloc] 
                                              initWithStyle:UITableViewStylePlain];
    infiniteController.title = @"Infinite Drilldown";
    infiniteController.rowImage = [UIImage imageNamed:@"infinite.png"];
    [array addObject:infiniteController];
    [infiniteController release];
